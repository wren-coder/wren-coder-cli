...
// --- New Type Definitions for LangGraph Compatibility ---
// Define a type representing content parts suitable for LangGraph.
// LangGraph often expects an array of content items with type and value fields.
// This mirrors the functionality of PartUnion but for LangGraph.
...
/**
 * Result structure for processing a single file.
 * Updated to use LangGraph compatible content structure.
 */
export interface ProcessedFileReadResult {
    llmContent: LangGraphContentPart[]; // Array of content parts for LangGraph
