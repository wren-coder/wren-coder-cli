...
import { DEFAULT_MODEL, DEFAULT_THINKING_MODEL } from './modelRegistry.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should update the model and mark as switched during session', () => {
      ...
      config.setModel(DEFAULT_THINKING_MODEL);

      expect(config.getModel()).toBe(DEFAULT_THINKING_MODEL);
    ...
    it('should only mark as switched if contentGeneratorConfig exists', () => {
      ...
      newConfig.setModel(DEFAULT_THINKING_MODEL);
