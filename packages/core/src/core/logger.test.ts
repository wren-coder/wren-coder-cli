...
const TEST_DIR = path.join(os.homedir(), DIR_NAME, TMP_DIR_NAME, hash);

const TEST_LOG_FILE_PATH = path.join(TEST_DIR, LOG_FILE_NAME);
const TEST_CHECKPOINT_FILE_PATH = path.join(TEST_DIR, CHECKPOINT_FILE_NAME);
